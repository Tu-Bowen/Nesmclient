...
//获取热评     /comment/hot?type=0&id=167876
export function getHotComment(id, type = 0) {
  return request({
    url: '/comment/hot',
    cancelToken:new CancelToken((cancel)=>{
      getHotComment.cancel=cancel
    }),
    params: {
      id,
      type,
...
export function getSimilaritySong(songid) {
  return request({
    url: '/simi/song',
    cancelToken:new CancelToken((cancel)=>{
      getSimilaritySong.cancel=cancel
    }),
    params: {
      id: songid,
    },
