...
export const getTopBannersAction = () => {
  return (dispatch) => {
    ...
    getTopBannersAction.cancel=getTopBanners.cancel
  }
}
...
export const getHostBannersAction = (limit) => {
  return (dispatch) => {
    ...
    getTopBannersAction.cancel=getHotRecommends.cancel
  }
}
...
export const getNewAlbumsAction = () => {
  return (dispatch) => {
    ...
    getNewAlbumsAction.cancel=getNewAlbums.cancel
  }
}
...
export const getTopListAction = (idx) => {
  return (dispatch) => {
    ...
    getTopListAction.cancel=getToplistDetail.cancel
  }
}
